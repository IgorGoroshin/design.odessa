...
<body>
	<div id="container">
		<div id="header" style="text-align:center">
                        ...
                        <ul id="navlist">
                        <?php
                        echo "<li>".$this->Html->link('Главная', '/') . "</li> ";
                        echo "<li>".$this->Html->link('О нас', '/about') . "</li> "; 
                        echo "<li>".$this->Html->link('Проекты', '/projects'). "</li> "; 
                        echo "<li>".$this->Html->link('Галерея', '/gallery'). "</li> "; 
                        echo "<li>".$this->Html->link('Примеры работ', '/examples'). "</li> "; 
                        echo "<li>".$this->Html->link('Обратная связь', '/contact'). "</li> "; 
                        ?>
                        </ul>
                        </div>
                        </div>
